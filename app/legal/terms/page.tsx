...
export const metadata: Metadata = {
  title: 'Terms & Conditions | NMG Tours Jamaica',
  description: 'Terms and conditions for using NMG Tours Jamaica tourism services and booking tours.',
}
...
export default function TermsPage() {
  return (
    <div className="w-full px-6 sm:px-8 lg:px-10 py-12 max-w-3xl mx-auto">
      ...
      <div className="bg-black/40 backdrop-blur-md rounded-lg p-8 border border-white/10 space-y-6">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">2. Services Description</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">3. User Accounts</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">4. Booking Terms</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">5. Cancellation and Refund Policy</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">6. Guest Responsibilities</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">7. Host Terms</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">8. Prohibited Activities</h2>
            <div className="space-y-3 text-zinc-300">
              <p>You may not:</p>
              <ul className="list-disc ml-6 space-y-1">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">9. Intellectual Property</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">10. Privacy</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">11. Disclaimers and Limitations of Liability</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">12. Indemnification</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">13. Dispute Resolution</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">14. General Terms</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">15. Contact Information</h2>
          ...
          <div className="mt-12 p-4 bg-emerald-900/20 rounded-lg">
