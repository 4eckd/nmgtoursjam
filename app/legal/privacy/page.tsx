...
export const metadata: Metadata = {
  title: 'Privacy Policy | NMG Tours Jamaica',
  description: 'Privacy policy for NMG Tours Jamaica - How we collect, use, and protect your personal information.',
}
    ...
    <div className="w-full px-6 sm:px-8 lg:px-10 py-12 max-w-3xl mx-auto">
      ...
      <div className="bg-black/40 backdrop-blur-md rounded-lg p-8 border border-white/10 space-y-6">
          <div className="text-sm text-zinc-400 mb-8">
            <p>Effective Date: October 26, 2025</p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">3. How We Use Your Information</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">4. Information Sharing and Disclosure</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">5. Data Security</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">6. Your Rights and Choices</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">7. Cookies and Tracking Technologies</h2>
            <div className="space-y-3 text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">8. Third-Party Links</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">9. Children Privacy</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">10. Data Retention</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">11. International Data Transfers</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">12. California Privacy Rights</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">13. Changes to This Policy</h2>
            <p className="text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-emerald-400">14. Contact Us</h2>
